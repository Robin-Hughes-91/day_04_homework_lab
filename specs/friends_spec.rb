...
class TestFriends < MiniTest::Test
  ...
  def test_getting_show
    result = getting_show(@person2)
  ...
  def test_remove_friend
    result = remove_friend(@person3, "Velma")
  ...
  def test_everyones_favourited_food
    result = everyones_favourited_food(@people)
